...
class AdviceFoodScreen extends StatefulWidget {
  ...
  AdviceFoodScreen({Key key, this.restModel, this.categoryModel})
      : super(key: key);
  @override
  _AdviceFoodScreenState createState() => _AdviceFoodScreenState();
}

class _AdviceFoodScreenState extends State<AdviceFoodScreen> {
                    ...
                    Row(
                      ...
                      children: [
                        (loadding)
                            ...
                            : MyStyle().txtTHRed('ไม่มีรายการในเมนูแนะนำ')
                      ],
                    ),
                  ],
                ),
